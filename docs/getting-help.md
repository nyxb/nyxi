...
Something isn't working the way that the docs say that it should. You're not sure if it's a bug. You've searched through the [open issues](https://github.com/nyxb/nyxi/issues) and [discussions](#) but you can't find anything. (if there is a closed issue, please create a new one)
